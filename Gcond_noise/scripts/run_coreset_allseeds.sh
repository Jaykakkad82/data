...
do
    ...
    do     
        python train_coreset.py --dataset cora --r=${r}  --method=herding --seed=${s}
        python train_coreset.py --dataset cora --r=${r}  --method=random  --seed=${s}
        python train_coreset.py --dataset cora --r=${r}  --method=kcenter  --seed=${s}
        python train_coreset.py --dataset cora --r=${r}  --method=kmeans  --seed=${s}

    done

    for r in 0.5 0.25 0.125
    do
        python train_coreset.py --dataset citeseer --r=${r}  --method=herding --seed=${s}
        python train_coreset.py --dataset citeseer --r=${r}  --method=random --seed=${s}
        python train_coreset.py --dataset citeseer --r=${r}  --method=kcenter --seed=${s}
        python train_coreset.py --dataset citeseer --r=${r}  --method=kmeans --seed=${s}
    done
