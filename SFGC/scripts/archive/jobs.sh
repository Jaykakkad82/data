...
--load_path='./logs/Distill/reddit-reduce_0.0005-20240110-032508-237194' \
--tr_seed=61 --seed=61
...
--best_ntk_score 1 --test_opt_type Adam --test_model_type GCN \
--load_path='./logs/Distill/reddit-reduce_0.005-20240110-053012-950988' \
--tr_seed=61 --seed=61
...
--best_ntk_score 1 --test_opt_type Adam --test_model_type GCN \
--load_path='./logs/Distill/reddit-reduce_0.001-20240111-024543-657266' \
--tr_seed=61 --seed=61
