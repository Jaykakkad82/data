...
#@flickr-r0001
CUDA_VISIBLE_DEVICES=0 python train_coreset_inductive.py --dataset flickr --device cuda:0 --epochs 1000 --lr 0.001 --weight_decay 5e-4  --save 1 --method kcenter --reduction_rate 0.001 --load_npy '' --seed 37 > ./logs/flickr_train_coreset_inductive_0001
...
#@flickr-r0005
CUDA_VISIBLE_DEVICES=0 python train_coreset_inductive.py --dataset flickr --device cuda:0 --epochs 800 --lr 0.001 --weight_decay 5e-4  --save 1 --method kcenter --reduction_rate 0.005 --load_npy '' --seed 37 > ./logs/flickr_train_coreset_inductive_0005
...
#@flickr-r001
CUDA_VISIBLE_DEVICES=0 python train_coreset_inductive.py --dataset flickr --device cuda:0 --epochs 800 --lr 0.001 --weight_decay 5e-4  --save 1 --method kcenter --reduction_rate 0.01 --load_npy '' --seed 37 > ./logs/flickr_train_coreset_inductive_001
