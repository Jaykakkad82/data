...
# --buffer_path './logs/Buffer/flickr-20240111-032924-671511' \
# --coreset_init_path './logs/Coreset/flickr-reduce_0.001-20240111-181203-468370' \
...
--start_epoch=30 --syn_steps=600 \
--buffer_path './logs/Buffer/flickr-20240111-032924-671511' \
--coreset_init_path './logs/Coreset/flickr-reduce_0.005-20240111-181455-604114' \
--condense_model GCN --interval_buffer 1 --rand_start 1 \
...
--buffer_path './logs/Buffer/flickr-20240111-032924-671511' \
--coreset_init_path './logs/Coreset/flickr-reduce_0.01-20240111-181720-100939' \
--condense_model GCN --interval_buffer 1 --rand_start 1 \
